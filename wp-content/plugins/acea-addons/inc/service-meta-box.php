 ...
 */
class service_icon {
	private $config = '{"title":"Service Icon","prefix":"service_icon","domain":"acea-addons","class_name":"service_icon","context":"normal","priority":"default","cpt":"acea-service","fields":[{"type":"media","label":"Icon","return":"url","modal-title":"Icon","modal-button":"Icon","id":"service_iconicon"}]}';
	...
	private function media_button( $field ) {
		printf(
			...
			isset( $field['modal-button'] ) ? $field['modal-button'] : __( 'Select this file', 'acea-addons' ),
			isset( $field['modal-title'] ) ? $field['modal-title'] : __( 'Choose a file', 'acea-addons' ),
			$field['return'],
			$field['id'], $field['id'],
			isset( $field['button-text'] ) ? $field['button-text'] : __( 'Upload', 'acea-addons' )
		);
	}
