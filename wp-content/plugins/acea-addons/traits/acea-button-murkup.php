...
trait Button_Markup {
    public function render_estilo_markup($settings) {
        $this->add_render_attribute( 'wrap', 'class', 'acea-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'acea-creative-btn', 'acea-stl--' . $settings['btn_style'], 'acea-eft--' .$settings['estilo_effect'] ] );
...
EOF;
    ...
    public function render_symbolab_markup($settings){
        $this->add_render_attribute( 'wrap', 'class', 'acea-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'acea-creative-btn', 'acea-stl--' . $settings['btn_style'], 'acea-eft--' .$settings['symbolab_effect'] ] );
        $this->add_link_attributes( 'button', $settings['button_link'] );
		$wrap_attr = $this->get_render_attribute_string( 'wrap' );
		$btn_attr = $this->get_render_attribute_string( 'button' );
		$btn_txt = $settings['button_text'];
...
EOF;
    ...
    public function render_iconica_markup($settings){
		$this->add_render_attribute( 'wrap', 'class', 'acea-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'acea-creative-btn', 'acea-stl--' . $settings['btn_style'], 'acea-eft--' .$settings['iconica_effect'] ] );
        $this->add_link_attributes( 'button', $settings['button_link'] );
		$wrap_attr = $this->get_render_attribute_string( 'wrap' );
		$btn_attr = $this->get_render_attribute_string( 'button' );
		$btn_txt = $settings['button_text'];
...
EOF;
    ...
    public function render_montino_markup($settings){
		$this->add_render_attribute( 'wrap', 'class', 'acea-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'acea-creative-btn', 'acea-stl--' . $settings['btn_style'], 'acea-eft--' .$settings['montino_effect'] ] );
        $this->add_link_attributes( 'button', $settings['button_link'] );
...
EOF;
    ...
    public function render_hermosa_markup($settings){
		$this->add_render_attribute( 'wrap', 'class', 'acea-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'acea-creative-btn', 'acea-stl--' . $settings['btn_style'], 'acea-eft--' .$settings['hermosa_effect'] ] );
        $this->add_link_attributes( 'button', $settings['button_link'] );
		$wrap_attr = $this->get_render_attribute_string( 'wrap' );
		$btn_attr = $this->get_render_attribute_string( 'button' );
		$btn_txt = $settings['button_text'];
