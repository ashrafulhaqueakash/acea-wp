 ...
 * @since 1.0.0
 */
class Acea_Blog extends \Elementor\Widget_Base
{
    /**
    ...
    {
        $post_categories =  acea_addons_cpt_taxonomy_slug_and_name('category');
        ...
        $this->add_control(
            'enable_masonry',
            [
                'label' => __('Enable Masonry?', 'acea-addons'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Enable Slider?', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'posts_per_page',
            [
                'label' => __('Posts per page', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::NUMBER,
                'default' => 5,
            ]
        );
        $this->add_responsive_control('per_line', [
            'label'              => __('Columns per row', 'acea-addons-hp'),
        ...
        $this->add_control(
            'post_style',
            [
                'label' => __('Select style', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'style-one',
                'options' => array(
                    'style-one' => 'Style 1',
        ...
        $this->add_responsive_control(
            'post_grid',
            [
                'label' => __('Post grid', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => array(
                    '12' => '1 Column',
                    '6' => '2 Column',
        ...
        $this->add_control(
            'manual_selection',
            [
                'label'         => __('Manual Selection', 'acea-addons'),
                'type'          => \Elementor\Controls_Manager::SELECT2,
                'description'   => __('Get specific template posts', 'acea-addons'),
                'label_block'   => true,
                'multiple'      => true,
                'options'       => acea_addons_cpt_slug_and_id('post'),
                'default' =>    [],
                'condition' => [
        ...
        $this->add_control(
            'include_by',
            [
                'label'         => __('Include by', 'acea-addons'),
                'type'          => \Elementor\Controls_Manager::SELECT2,
                'label_block'   => true,
                'multiple'      => true,
                'options'       => [
        ...
        $this->add_control(
            'include_categories',
            [
                'label'         => __('Include categories', 'acea-addons'),
                'type'          => \Elementor\Controls_Manager::SELECT2,
                'description'   => __('Get templates for specific category(s)', 'acea-addons'),
                'label_block'   => true,
                'multiple'      => true,
                'options'       => acea_addons_cpt_taxonomy_slug_and_name('category'),
                'default' =>    [],
                'condition' => [
                    'include_by' => 'category',
                    'source!' => 'related',
        ...
        $this->add_control(
            'include_tags',
            [
                'label'         => __('Include Tags', 'acea-addons'),
                'type'          => \Elementor\Controls_Manager::SELECT2,
                'description'   => __('Get templates for specific tag(s)', 'acea-addons'),
                'label_block'   => true,
                'multiple'      => true,
                'options'       => acea_addons_cpt_taxonomy_slug_and_name('post_tag'),
                'default' =>    [],
                'condition' => [
                    'include_by' => 'tags',
                    'source!' => 'related',
        ...
        $this->add_control(
            'include_authors',
            [
                'label'         => __('Include authors', 'acea-addons'),
                'type'          => \Elementor\Controls_Manager::SELECT2,
                'description'   => __('Get templates for specific tag(s)', 'acea-addons'),
                'label_block'   => true,
                'multiple'      => true,
                'options'       => acea_addons_cpt_author_slug_and_id('post'),
                'default' =>    [],
                'condition' => [
                    'include_by' => 'author',
                    'source!' => 'manual_selection'
        ...
        $this->add_control(
            'exclude_by',
            [
                'label'         => __('Exclude by', 'acea-addons'),
                'type'          => \Elementor\Controls_Manager::SELECT2,
                'label_block'   => true,
                'multiple'      => true,
                'options'       => [
        ...
        $this->add_control(
            'exclude_categories',
            [
                'label'         => __('Exclude categories', 'acea-addons'),
                'type'          => \Elementor\Controls_Manager::SELECT2,
                'description'   => __('Get templates for specific category(s)', 'acea-addons'),
                'label_block'   => true,
                'multiple'      => true,
        ...
        $this->add_control(
            'exclude_tags',
            [
                'label'         => __('Exclude Tags', 'acea-addons'),
                'type'          => \Elementor\Controls_Manager::SELECT2,
                'description'   => __('Get templates for specific tag(s)', 'acea-addons'),
                'label_block'   => true,
                'multiple'      => true,
        ...
        $this->add_control(
            'exclude_authors',
            [
                'label'         => __('Exclude authors', 'acea-addons'),
                'type'          => \Elementor\Controls_Manager::SELECT2,
                'description'   => __('Get templates for specific tag(s)', 'acea-addons'),
                'label_block'   => true,
                'multiple'      => true,
        ...
        $this->add_control(
            'show_excerpt',
            [
                'label' => __('Show Content', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Show', 'acea-addons'),
                'label_off' => __('Hide', 'acea-addons'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'title_limit',
            [
                'label' => __('Title Limit', 'acea-addons'),
        ...
        $this->add_control(
            'show_category',
            [
                'label' => __('Show Category', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Show', 'acea-addons'),
                'label_off' => __('Hide', 'acea-addons'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'cat_icon',
            [
                'label' => __('Date Icon', 'acea-addons'),
        ...
        $this->add_control(
            'show_author',
            [
                'label' => __('Show Author', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Show', 'acea-addons'),
                'label_off' => __('Hide', 'acea-addons'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'author_text',
            [
                'label' => __('Author Label', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('Sakib Vai', 'acea-addons'),
                'condition' => [
                    'show_author' => 'yes',
                ]
            ]
        ...
        $this->add_control(
            'author_icon',
            [
                'label' => __('Author Icon', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::ICONS,
                'condition' => [
                    'show_author' => 'yes',
                ]
        ...
        $this->add_control(
            'show_comment',
            [
                'label' => __('Show Comment', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Show', 'acea-addons'),
                'label_off' => __('Hide', 'acea-addons'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'comment_text',
            [
                'label' => __('Commnent Label', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('Comment', 'acea-addons'),
                'condition' => [
                    'show_comment' => 'yes',
                ]
            ]
        ...
        $this->add_control(
            'comment_icon',
            [
                'label' => __('Comment Icon', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::ICONS,
                'condition' => [
                    'show_comment' => 'yes',
                ]
        ...
        $this->add_control(
            'show_readmore',
            [
                'label' => __('Readmore button', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Show', 'acea-addons'),
                'label_off' => __('Hide', 'acea-addons'),
                'return_value' => 'yes',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'devices' => ['desktop', 'tablet', 'mobile'],
                'selectors' => [
                    '{{WRAPPER}} .acea-addons-post-widget-item.post-style-list .post-thumbnail img'  => 'width: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .acea-addons-post-widget-item.post-style-list .post-thumbnail-wrapper'  => 'flex: 0 0 {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        */
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'cat_typography',
                'label' => __('Category Typography', 'acea-addons'),
        ...
        $this->add_control(
            'category_color',
            [
                'label' => __('Category Color', 'acea-addons'),
        ...
        $this->add_control(
            'category_bg_color',
            [
                'label' => __('Category Background Color', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Category Hover Color', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Category Hover Background Color', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        */
        ...
        $this->add_control(
            ...
            [
                'label' => __('SVG Line Color', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Meta Margin', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    ' {{WRAPPER}} .post-top-meta' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        */
        $this->start_controls_section(
            ...
            [
                'label' => __('On Image Category', 'acea-addons'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        */
        $this->start_controls_section(
            'meta_bottom_style',
            [
                'label' => __('Bottom Meta', 'acea-addons'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_group_control(
        ...
        */
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .acea-addons-post-widget-item .post-title',
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
            [
                ...
                'selector' => '{{WRAPPER}} .acea-addons-post-widget-item p',
                'condition' => [
                    'show_excerpt' => 'yes'
                ]
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-addons-post-widget-item .post-content' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-addons-post-widget-item .post-title' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-addons-post-widget-item p' => 'color: {{VALUE}}',
                ],
                'condition' => [
                    'show_excerpt' => 'yes'
                ]
        ...
        $this->add_control(
            'post_content_hover_background',
            [
                'label' => __('Background Color', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-addons-post-widget-item:hover .post-content' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-addons-post-widget-item:hover .post-title' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-addons-post-widget-item:hover p' => 'color: {{VALUE}}',
                ],
                'condition' => [
                    'show_excerpt' => 'yes'
                ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .acea-addons-post-widget-item .post-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    'body.rtl {{WRAPPER}} .acea-addons-post-widget-item .post-title' => 'margin: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
                ]
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .acea-addons-post-widget-item .post-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    'body.rtl {{WRAPPER}} .acea-addons-post-widget-item .post-content' => 'padding: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
                ]
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-addons-post-widget-item:hover .post-btn .btn-icon' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .acea-addons-post-widget-item:hover .post-btn .btn-icon path' => 'fill: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Typography', 'acea-addons'),
                'selector' => '{{WRAPPER}} .acea-addons-post-widget-item:hover .post-btn',
            ]
        );
        $this->add_control(
            'icon_hover_size',
            [
                'label' => __('Hover Icon Size', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', '%'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .acea-addons-post-widget-item:hover .post-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .acea-addons-post-widget-item:hover .post-btn' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->start_controls_section(
            'section_pagination',
            [
                'label' => __('Pagination', 'acea-addons'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                'conditon' => [
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
            [
                'label' => __('Pagination typography', 'acea-addons'),
                'name' => 'pagi_typography',
                'selector' => '{{WRAPPER}} .acea-addons-pagination  a, {{WRAPPER}} .acea-addons-pagination span',
                'condition' => [
                    'enable_pagination' => 'yes'
                ],
            ]
        ...
        $this->add_control(
            'pagi_color',
            [
                'label' => __('Pagination Color', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-addons-pagination > a' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .acea-addons-pagination > span ' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .acea-addons-pagination a span.acea-addons-pagination-icon ' => 'color: {{VALUE}}',
                ],
                'condition' => [
                    'enable_pagination' => 'yes'
                ],
        ...
        $this->add_control(
            'pagi_bg_color',
            [
                'label' => __('Pagination Background Color', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-addons-pagination > a' => 'background-color: {{VALUE}}',
                    '{{WRAPPER}} .acea-addons-pagination > span ' => 'background-color: {{VALUE}}',
                    '{{WRAPPER}} .acea-addons-pagination a span.acea-addons-pagination-icon' => 'background-color: {{VALUE}}',
                ],
                'condition' => [
                    'enable_pagination' => 'yes'
                ],
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'page_border',
                'label' => __('Pagination Border', 'acea-addons'),
                'selector' => '{{WRAPPER}} .acea-addons-pagination > a, {{WRAPPER}} .acea-addons-pagination > span',
                'condition' => [
                    'enable_pagination' => 'yes'
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .acea-addons-pagination'    => 'text-align: {{VALUE}};',
                ],
                'devices' => ['desktop', 'tablet', 'mobile'],
                'toggle' => true,
            ]
        ...
        $this->add_responsive_control(
            'pagi_margin',
            [
                'label' => __('Pagination Margin', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .acea-addons-pagination'    => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} acea-addons-pagination' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'enable_pagination' => 'yes'
        ...
        $this->add_responsive_control(
            'pagi_radius',
            [
                'label' => __('Pagination Border Radius', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .acea-addons-pagination > a'    => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .acea-addons-pagination > span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'enable_pagination' => 'yes'
                ],
        ...
        $this->add_control(
            'pagi_hover_color',
            [
                'label' => __('Pagination Hover Color', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-addons-pagination > a:hover' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .acea-addons-pagination > span:hover ' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .acea-addons-pagination > span.current ' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .acea-addons-pagination a:hover span.acea-addons-pagination-icon ' => 'color: {{VALUE}}',
                ],
                'condition' => [
                    'enable_pagination' => 'yes'
                ],
        ...
        $this->add_control(
            'pagi_hover_bg_color',
            [
                'label' => __('Pagination Background Hover Color', 'acea-addons'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-addons-pagination > a:hover' => 'background-color: {{VALUE}}',
                    '{{WRAPPER}} .acea-addons-pagination > span:hover ' => 'background-color: {{VALUE}}',
                    '{{WRAPPER}} .acea-addons-pagination > span.current ' => 'background-color: {{VALUE}}',
                    '{{WRAPPER}} .acea-addons-pagination a:hover span.acea-addons-pagination-icon' => 'background-color: {{VALUE}}',
                ],
                'condition' => [
                    'enable_pagination' => 'yes'
                ],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Pagination Hover Border', 'acea-addons'),
                'selector' => '{{WRAPPER}} .acea-addons-pagination > a:hover, {{WRAPPER}} .acea-addons-pagination > span:hover,{{WRAPPER}} .acea-addons-pagination > span.current',
                'condition' => [
                    'enable_pagination' => 'yes'
                ],
            ]
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Content Background Color', 'acea-addons'),
            ]
        );
        $this->add_responsive_control(
            'content_radius',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .acea-addons-post-widget-item .post-content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
   ...
   */
        $this->start_controls_section(
            'arrows_navigation',
            [
                'label' => __('Navigation - Arrow', 'acea-addons-hp'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                'condition' => [
                    'arrows' => 'yes',
                ],
        ...
        $this->start_controls_tab(
            '_tab_arrow_normal',
            [
                'label' => __('Normal', 'acea-addons-hp'),
            ]
        );
        $this->add_control(
            'arrow_color',
            [
                'label' => __('Color', 'acea-addons-hp'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'arrow_color_fill',
            [
                'label' => __('Line Color', 'acea-addons-hp'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'arrow_bg_color',
            [
                'label' => __('Background Color', 'acea-addons-hp'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Position', 'acea-addons-hp'),
                'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
                'label_off' => __('None', 'acea-addons-hp'),
                'label_on' => __('Custom', 'acea-addons-hp'),
                'return_value' => 'yes',
            ]
        );
        $this->start_popover();
        ...
        $this->add_responsive_control(
            'arrow_position_top',
            [
                'label' => __('Vertical', 'acea-addons-hp'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['%', 'px'],
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label'             => __('Horizontal Position', 'acea-addons-hp'),
                'type'              => \Elementor\Controls_Manager::SELECT,
                'default'           => 'default',
                'options'           => [
                    'default'    =>   __('Default',    'acea-addons-hp'),
                    'space_between'    =>   __('Space Between',    'acea-addons-hp'),
                ],
                'separator' => 'after',
            ]
        );
        ...
        $this->add_responsive_control(
            'align_arrow',
            [
                'label' => __('Alignment', 'acea-addons-hp'),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => __('Left', 'acea-addons-hp'),
                        'icon' => 'eicon-text-align-left',
                    ],
                    'center' => [
                        'title' => __('Center', 'acea-addons-hp'),
                        'icon' => 'eicon-text-align-center',
                    ],
                    'right' => [
                        'title' => __('Right', 'acea-addons-hp'),
        ...
        $this->add_responsive_control(
            'arrow_icon_size',
            [
                'label' => __('Icon Size', 'acea-addons-hp'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Line Height', 'acea-addons-hp'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => __('Border Radius', 'acea-addons-hp'),
                'type'       => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px'],
                'selectors'  => [
        ...
        $this->start_controls_tab(
            '_tab_arrow_hover',
            [
                'label' => __('Active', 'acea-addons-hp'),
            ]
        );
        $this->add_control(
            'arrow_hover_color',
        ...
        $this->add_control(
            ...
            [
                'label' => __('Background Color Hover', 'acea-addons-hp'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-addons-post-widget-item' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .acea-addons-post-widget-item',
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Border::get_type(),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'      => [
                    '{{WRAPPER}} .acea-addons-post-widget-wrap' => 'padding: 0 {{SIZE}}{{UNIT}};',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'      => [
                    '{{WRAPPER}} .acea-addons-post-widget-wrap' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .acea-addons-blog-wraper' => 'margin-bottom: -{{SIZE}}{{UNIT}};',
                ],
            ]
        );
        /*      $this->end_popover(); */
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .acea-addons-post-widget-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    'body.rtl {{WRAPPER}} .acea-addons-post-widget-item' => 'border-radius: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    ' {{WRAPPER}} .acea-addons-post-widget-item ' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'defautl' => '#233aff',
                'selectors' => [
                    '{{WRAPPER}} .acea-addons-post-widget-item:hover:after' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .acea-addons-post-widget-item:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    'body.rtl {{WRAPPER}} .acea-addons-post-widget-item:hover' => 'border-radius: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Box Hover Shadow', 'acea-addons'),
                'selector' => '{{WRAPPER}} .acea-addons-post-widget-item:hover',
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Border::get_type(),
    ...
    protected function render()
    {
        ...
        if (('yes' == $settings['show_slider_settings'])) {
            ...
            $this->add_render_attribute('grid_classes', 'class', [$grid_classes, 'acea-addons-post-widget-wrap co-lg-6', $image_hover_style]);
        }
        ...
        <div class="acea-addons-blog-wraper">
            <div <?php echo $this->get_render_attribute_string('blog_version'); ?>>
                ...
                while ($the_query->have_posts()) : $the_query->the_post(); ?>
                    ...
                    if ('top' == $settings['author_position']) {
                        $top_meta .= 'yes' == $settings['show_author'] ? acea_addons_posted_by($author_icon) : '';
                    } else {
                        $bottom_meta .= 'yes' == $settings['show_author'] ? acea_addons_posted_by($author_icon) : '';
                    }
                    ...
                    if ('top' == $settings['date_position']) {
                        $top_meta .= 'yes' == $settings['show_date'] ? acea_addons_posted_date($date_icon) : '';
                    } else {
                        $bottom_meta .= 'yes' == $settings['show_date'] ? acea_addons_posted_date($date_icon) : '';
                    }
                    // category meta
                    if ('top' == $settings['cat_position']) {
                        $top_meta .= 'yes' == $settings['show_category'] ? acea_addons_posted_category($cat_icon) : '';
                    } else {
                        $bottom_meta .= 'yes' == $settings['show_category'] ? acea_addons_posted_category($cat_icon) : '';
                    }

                    // Comment meta
                    if ('top' == $settings['comment_position']) {
                        $top_meta .= 'yes' == $settings['show_comment'] ? acea_addons_comment_count($comment_text, $comment_icon) : '';
                    } else {
                        $bottom_meta .= 'yes' == $settings['show_comment'] ? acea_addons_comment_count($comment_text, $comment_icon) : '';
                    }
                    ?>
                    <div <?php echo $this->get_render_attribute_string('grid_classes'); ?>>
                        <div class="acea-addons-post-widget-item <?php printf('post-style-%s', esc_attr($settings['post_style'])) ?>">
                            <?php if ($blog_style) {
...
<?php
        if ($settings['enable_pagination']) :
            ...
            echo '<div class="row"><div class="col-12"><div class="acea-addons-pagination">';
            echo paginate_links(array(
                'base' => str_replace($big, '%#%', get_pagenum_link($big)),
                'format' => '?paged=%#%',
                'current' => max(1, get_query_var('paged')),
                'prev_text' => '<span class="acea-addons-pagination-icon"><i class="fas fa-angle-left"> </i></span>',
                'next_text' => '<span class="acea-addons-pagination-icon"><i class="fas fa-angle-right"> </i></span>',
...
$widgets_manager->register_widget_type(new \Acea_Addons\Widgets\Acea_Blog());
