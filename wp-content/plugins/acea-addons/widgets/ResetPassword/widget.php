...
class Acea_Pass extends \Elementor\Widget_Base
{
    /**
    ...
    {
        return __('Acea Reset Password', 'acea-addons');
    }
    /**
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                'label'         => __('Privacy Policy Link', 'fd-addons'),
                'type'             => \Elementor\Controls_Manager::HEADING,
                'separator'     => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'raw'          => sprintf(
                    __('Select your Privacy Policy page in the %1$sPrivacy Settings%2$s', 'fd-addons'),
    ...
    protected function render()
    {
        ...
        <form class="fd-addons-form" method="post" action="<?php echo wp_lostpassword_url(); ?>">
            ...
            if ($show_privacy_policy && function_exists('the_privacy_policy_link')) {
                the_privacy_policy_link('<div class="fd-addons-privacy">', '</div>');
            } ?>
...
$widgets_manager->register_widget_type(new Acea_Pass());
