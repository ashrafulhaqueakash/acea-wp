...
class Acea_Login extends \Elementor\Widget_Base
{
    /**
    ...
    {
        return __('Acea Sign In', 'acea-hp');
    }
    /**
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'acea_form_show_label'   => 'yes',
                    'acea_form_show_customlabel' => 'yes',
                ],
            ]
        );

        $this->add_control(
            'acea_user_placeholder',
            [
        ...
        $this->add_control(
            'acea_forget_button_existing_link',
            [
        ...
        $this->start_controls_section(
            'acea_login_showpass_style',
            [
                'label' => __('Show Password', 'fd-addons'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                'condition' => [
                    'acea_form_show_password' => 'yes',
                ]
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper input'   => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper input[type*="text"]::-webkit-input-placeholder'  => 'color: {{VALUE}};',
                    '{{WRAPPER}} .acea-login-form-wrapper input[type*="text"]::-moz-placeholder'  => 'color: {{VALUE}};',
                    '{{WRAPPER}} .acea-login-form-wrapper input[type*="text"]:-ms-input-placeholder'  => 'color: {{VALUE}};',
                    '{{WRAPPER}} .acea-login-form-wrapperinput[type*="password"]::-webkit-input-placeholder'  => 'color: {{VALUE}};',
                    '{{WRAPPER}} .acea-login-form-wrapper input[type*="password"]::-moz-placeholder'  => 'color: {{VALUE}};',
                    '{{WRAPPER}} .acea-login-form-wrapper input[type*="password"]:-ms-input-placeholder'  => 'color: {{VALUE}};',
                    '{{WRAPPER}} .acea-login-form-wrapperinput[type*="email"]::-webkit-input-placeholder'  => 'color: {{VALUE}};',
                    '{{WRAPPER}} .acea-login-form-wrapper input[type*="email"]::-moz-placeholder'  => 'color: {{VALUE}};',
                    '{{WRAPPER}} .acea-login-form-wrapper input[type*="email"]:-ms-input-placeholder'  => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .acea-login-form-wrapper input',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper input[type="text"],{{WRAPPER}} .acea-login-form-wrapper input[type="password"]' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper input' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper input' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    'body.rtl {{WRAPPER}} .acea-login-form-wrapper input' => 'margin: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper input' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    'body.rtl {{WRAPPER}} .acea-login-form-wrapper input' => 'padding: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'             => \Elementor\Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}} .acea-login-form-wrapper input:focus' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'             => \Elementor\Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}} .acea-login-form-wrapper input:focus' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Border', 'fd-addons'),
                'selector' => '{{WRAPPER}} .acea-login-form-wrapper input:focus',
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper label' => 'text-align: {{VALUE}};',
                ],
                'default' => 'left',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper label'   => 'color: {{VALUE}};',
                    '{{WRAPPER}} .acea-login-form-wrapper .login_register_text'   => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .acea-login-form-wrapper label,{{WRAPPER}} .acea-login-form-wrapper .login_register_text',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Background', 'fd-addons'),
                'types' => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .acea-login-form-wrapper label',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper label' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    'body.rtl {{WRAPPER}} .acea-login-form-wrapper label' => 'margin: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper label' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    'body.rtl {{WRAPPER}} .acea-login-form-wrapper label' => 'padding: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper label' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    'body.rtl {{WRAPPER}} .acea-login-form-wrapper label' => 'border-radius: {{TOP}}px {{LEFT}}px {{BOTTOM}}px {{RIGHT}}px;',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .acea-login-form-wrapper form .log-remember label',
            ]
        );
        ...
        //         ],
        //         'selectors' => [
        //             '{{WRAPPER}} .acea-login-form-wrapper form .log-remember label input[type="checkbox"]' => 'height: {{SIZE}}{{UNIT}};',
        //         ],
        //     ]
        // );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper form .log-remember label' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                    'body.rtl {{WRAPPER}} .acea-login-form-wrapper form .log-remember label' => 'margin: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}} !important;',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper form .log-remember label'   => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper input[type="submit"]'   => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .acea-login-form-wrapper input[type="submit"]',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper input[type="submit"]'   => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper input[type="submit"]' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper input[type="submit"]' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper input[type="submit"]' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    'body.rtl {{WRAPPER}} .acea-login-form-wrapper input[type="submit"]' => 'border-radius: {{TOP}}px {{LEFT}}px {{BOTTOM}}px {{RIGHT}}px;',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper input[type="submit"]' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    'body.rtl {{WRAPPER}} .acea-login-form-wrapper input[type="submit"]' => 'margin: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper input[type="submit"]' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    'body.rtl {{WRAPPER}} .acea-login-form-wrapper input[type="submit"]' => 'padding: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper input[type="submit"]:hover'   => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Background', 'fd-addons'),
                'types' => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .acea-login-form-wrapper input[type="submit"]:hover',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper input[type="submit"]:hover'   => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper' => 'text-align: {{VALUE}};',
                ],
                'default' => 'left',
                'separator' => 'before',
            ]
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Background', 'fd-addons'),
                'types' => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .acea-login-form-wrapper',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    'body.rtl {{WRAPPER}} .acea-login-form-wrapper' => 'margin: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .acea-login-form-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    'body.rtl {{WRAPPER}} .acea-login-form-wrapper' => 'padding: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render($instance = [])
    {
        ...
        $pages_link = get_permalink($settings['acea_reg_button_existing_link']);
        $resetpage_link = get_permalink($settings['acea_forget_button_existing_link']);
        ...
        $this->add_render_attribute('loginform_area_attr', 'class', 'acea-login-form-wrapper');

        // Label Value
        $user_label = isset($settings['acea_user_label']) ? $settings['acea_user_label'] : __('Username', 'fd-addons');
        $user_placeholder = isset($settings['acea_user_placeholder']) ? $settings['acea_user_placeholder'] : __('Username', 'fd-addons');
        $pass_label = isset($settings['acea_password_label']) ? $settings['acea_password_label'] : __('Password', 'fd-addons');
        $pass_placeholder = isset($settings['acea_password_placeholder']) ? $settings['acea_password_placeholder'] : __('Password', 'fd-addons');

?>
        <div <?php echo $this->get_render_attribute_string('loginform_area_attr'); ?>>

            <div id="acea_message_<?php echo esc_attr($id); ?>" class="acea_message">&nbsp;</div>
            ...
            ?>
            <form id="acea_login_form_<?php echo esc_attr($id); ?>" action="formloginaction" method="post">
                <div id="acea-form-fs">
                    <div class="form-field">
                        <?php
                        if ($settings['acea_form_show_label'] == 'yes') {
                    ...
                    <div class="form-field password-field position-relative">
                        ...
                        <?php if ($settings['acea_form_show_password'] == 'yes') : ?>
    ...
    <?php
        $this->acea_login_check($settings['redirect_page'], $redirect_url, $id);
    }
    public function acea_login_check($reddirectstatus, $redirect_url, $id)
    {
    ?>
        <script type="text/javascript">
            jQuery(document).ready(function($) {
                ...
                var login_form_id = 'form#acea_login_form_<?php echo esc_attr($id); ?>';
                ...
                $(login_button_id).on('click', function() {
                    ...
                    $('#acea_message_<?php echo esc_attr($id); ?>').html('<span class="acea_lodding_msg">' + loadingmessage + '</span>').fadeIn();
                    ...
                    $.ajax({
                        ...
                        success: function(msg) {
                            if (msg.loggeauth == true) {
                                $('#acea_message_<?php echo esc_attr($id); ?>').html('<div class="acea_success_msg alert alert-success">' + msg.message + '</div>').fadeIn();
                                if (redirect === 'yes') {
                                ...
                                $('#acea_message_<?php echo esc_attr($id); ?>').html('<div class="acea_invalid_msg alert alert-danger">' + msg.message + '</div>').fadeIn();
                            }
                        }
                    });
                    return false;
...
$widgets_manager->register_widget_type(new Acea_Login());
