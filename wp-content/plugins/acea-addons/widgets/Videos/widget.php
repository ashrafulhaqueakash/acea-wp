 ...
 * @since 1.0.0
 */
class Acea_Video extends Widget_Base {
    /**
     * Get widget name.
     *
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'            => 'youtube',
                'options'            => [
                    'youtube'     => __( 'YouTube', 'acea-addons' ),
                    'vimeo'       => __( 'Vimeo', 'acea-addons' ),
                    'dailymotion' => __( 'Dailymotion', 'acea-addons' ),
                    'hosted'      => __( 'Self Hosted', 'acea-addons' ),
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder'        => __( 'Enter your URL', 'acea-addons' ) . ' (YouTube)',
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __( 'Enter your URL', 'acea-addons' ) . ' (Vimeo)',
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __( 'Enter your URL', 'acea-addons' ) . ' (Dailymotion)',
        ...
        $this->add_control(
            'insert_url',
            [
                'label'     => __( 'External URL', 'acea-addons' ),
        ...
        $this->add_control(
            'hosted_url',
            [
                'label'      => __( 'Choose File', 'acea-addons' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'media_type'   => 'video',
                'placeholder'  => __( 'Enter your URL', 'acea-addons' ),
                'condition'    => [
                    'video_type' => 'hosted',
                    'insert_url' => 'yes',
                ],
        ...
        $this->add_control(
            'start',
            [
                'label'              => __( 'Start Time', 'acea-addons' ),
                'type'               => Controls_Manager::NUMBER,
                'description'        => __( 'Specify a start time (in seconds)', 'acea-addons' ),
                'frontend_available' => true,
            ]
        );
        $this->add_control(
            'end',
            [
                'label'              => __( 'End Time', 'acea-addons' ),
                'type'               => Controls_Manager::NUMBER,
                'description'        => __( 'Specify an end time (in seconds)', 'acea-addons' ),
                'condition'          => [
        ...
        $this->add_control(
            'video_options',
            [
                'label'     => __( 'Video Options', 'acea-addons' ),
        ...
        $this->add_control(
            'play_on_mobile',
            [
                'label'              => __( 'Play On Mobile', 'acea-addons' ),
                'type'               => Controls_Manager::SWITCHER,
                'condition'          => [
                    'autoplay' => 'yes',
                ],
        ...
        $this->add_control(
            'controls',
            [
                'label'              => __( 'Player Controls', 'acea-addons' ),
                'type'               => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'showinfo',
            [
                'label'     => __( 'Video Info', 'acea-addons' ),
                'type'      => Controls_Manager::SWITCHER,
                'label_off' => __( 'Hide', 'acea-addons' ),
                'label_on'  => __( 'Show', 'acea-addons' ),
                'default'   => 'yes',
        ...
        $this->add_control(
            'modestbranding',
            [
                'label'              => __( 'Modest Branding', 'acea-addons' ),
                'type'               => Controls_Manager::SWITCHER,
                'condition'          => [
                    'video_type' => ['youtube'],
                    'controls'   => 'yes',
        ...
        $this->add_control(
            'yt_privacy',
            [
                'label'              => __( 'Privacy Mode', 'acea-addons' ),
                'type'               => Controls_Manager::SWITCHER,
                'description'        => __( 'When you turn on privacy mode, YouTube won\'t store information about visitors on your website unless they play the video.', 'acea-addons' ),
                'condition'          => [
                    'video_type' => 'youtube',
                ],
                'frontend_available' => true,
        ...
        $this->add_control(
            'lazy_load',
            [
                'label'              => __( 'Lazy Load', 'acea-addons' ),
                'type'               => Controls_Manager::SWITCHER,
                'conditions'         => [
                    'relation' => 'or',
                    'terms'    => [
        ...
        $this->add_control(
            'rel',
            [
                'label'     => __( 'Suggested Videos', 'acea-addons' ),
                'type'      => Controls_Manager::SELECT,
                'options'   => [
                    ''    => __( 'Current Video Channel', 'acea-addons' ),
                    'yes' => __( 'Any Video', 'acea-addons' ),
                ],
                'condition' => [
                    'video_type' => 'youtube',
                ],
        ...
        $this->add_control(
            'vimeo_title',
            [
                'label'     => __( 'Intro Title', 'acea-addons' ),
                'type'      => Controls_Manager::SWITCHER,
                'label_off' => __( 'Hide', 'acea-addons' ),
                'label_on'  => __( 'Show', 'acea-addons' ),
                'default'   => 'yes',
        ...
        $this->add_control(
            'vimeo_portrait',
            [
                'label'     => __( 'Intro Portrait', 'acea-addons' ),
                'type'      => Controls_Manager::SWITCHER,
                'label_off' => __( 'Hide', 'acea-addons' ),
                'label_on'  => __( 'Show', 'acea-addons' ),
                'default'   => 'yes',
        ...
        $this->add_control(
            'vimeo_byline',
            [
                'label'     => __( 'Intro Byline', 'acea-addons' ),
                'type'      => Controls_Manager::SWITCHER,
                'label_off' => __( 'Hide', 'acea-addons' ),
                'label_on'  => __( 'Show', 'acea-addons' ),
                'default'   => 'yes',
        ...
        $this->add_control(
            'color',
            [
                'label'     => __( 'Controls Color', 'acea-addons' ),
        ...
        $this->add_control(
            'download_button',
            [
                'label'     => __( 'Download Button', 'acea-addons' ),
                'type'      => Controls_Manager::SWITCHER,
                'label_off' => __( 'Hide', 'acea-addons' ),
                'label_on'  => __( 'Show', 'acea-addons' ),
                'condition' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Image Overlay', 'acea-addons' ),
            ]
        );
        $this->add_control(
            'show_image_overlay',
        ...
        $this->add_control(
            'show_play_icon',
            [
                'label'     => __( 'Play Icon', 'acea-addons' ),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'condition' => [
                    'show_image_overlay'  => 'yes',
        ...
        $this->add_control(
            'aspect_ratio',
            [
                'label'              => __( 'Aspect Ratio', 'acea-addons' ),
                'type'               => Controls_Manager::SELECT,
                'options'            => [
                    '169' => '16:9',
                    '219' => '21:9',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'fields_options' => [
                    'text_shadow_type' => [
                        'label' => _x( 'Shadow', 'Text Shadow Control', 'acea-addons' ),
                    ],
                ],
                'condition'      => [
                    'show_image_overlay' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'UI Hover Color', 'acea-addons' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'                => __( 'Content Position', 'acea-addons' ),
                'type'                 => Controls_Manager::SELECT,
                'frontend_available'   => true,
                'options'              => [
                    ''    => __( 'Center', 'acea-addons' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label'              => __( 'Entrance Animation', 'acea-addons' ),
				...
				<div <?php echo $this->get_render_attribute_string( 'image-overlay' ); ?>>
					...
					<?php if ( 'yes' === $settings['show_play_icon'] ): ?>
						<div class="elementor-custom-embed-play" role="button">
							...
							<span class="elementor-screen-only"><?php echo __( 'Play Video', 'acea-addons' ); ?></span>
						</div>
					<?php endif;?>
				</div>
			<?php }?>
...
$widgets_manager->register_widget_type( new \Elementor\Acea_Video() );