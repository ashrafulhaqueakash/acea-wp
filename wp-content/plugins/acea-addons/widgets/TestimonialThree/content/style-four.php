...
<div class="acea-testimonial__single">
    <div class="acea-testimonial__meta-content d-flex align-items-center">
    ...
    ?>
    <div class="acea-testmonial-bottom">
        <div class="bottom-left">
            ...
            <span><?php
                    ...
                    <span class="acea-testimonial__rating-text">Rated <?php echo $item['rating_text']['size']; ?>/5</span>
                <?php
                    endif;
