...
class Acea_Icon_Box extends Widget_Base
{
	public function get_name()
	{
		return 'acea-icon-box';
	}
	public function get_title()
	{
		return esc_html__('Acea Icon Box', 'acea-addons');
	}
...
$widgets_manager->register_widget_type(new \Acea_Addons\Widgets\Acea_Icon_Box());
