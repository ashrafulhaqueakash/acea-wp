...
class Breadcrumb extends \Elementor\Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Typography', 'acea'),
                'selector' => '{{WRAPPER}} .acea-breadcrumbs',
            ]
        );
        $this->add_control(
            'breadcroumb_color',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .acea-breadcrumbs span' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                'label' => __('Link Color', 'acea'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-breadcrumbs a span' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-breadcrumbs span:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .acea-breadcrumbs a:hover span' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_tab();
    ...
    protected function render()
    {
        ...
        echo  $this->acea_breadcrumbs($settings['separator']); ?>
<?php
    }
    ...
    public static function acea_breadcrumbs($seperator = ' . ')
    {
        $sepOpt = $seperator;
        /* === OPTIONS === */
        ...
        $wrap_before = '<div class="acea-breadcrumbs">'; // the opening wrapper tag
...
$widgets_manager->register_widget_type( new \Acea_Addons\Widgets\Breadcrumb() );