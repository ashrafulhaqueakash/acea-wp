    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '.fa_grab_init', function(e){
            ...
            var $self = $(this),
                ...
                if ( "none" == $icon ) {
                    $('#'+$id).val('');
                    $('#'+$id).prev('.thickbox_special').find('span').html(aceaWLocalize.select_icon);
                } else {
                    $('#'+$id).val($icon);
        ...
        $(document).on('click', '.thickbox_special', function(e) {
            e.preventDefault();
            var wrap_parent = $(this).closest('.acea-repeater-info-wrapper'),
            ...
            if( data_type === "social_links" ) {
                ...
                $('#TB_window').addClass('acea-TB_window');
                ...
                var file_frame = wp.media.frames.file_frame = wp.media({
                    title: aceaWLocalize.upload,
                    library: {
                        type: 'image'
                    },
                    button: {
                        text: aceaWLocalize.select_img
                    },
                    multiple: false
                });
                file_frame.on('select', function(){
                    ...
                    if ( $remover.length ) {
                        ...
                        $self.after('<button style="display: inline-block;" class="sl-widget-media-remove button">'+ aceaWLocalize.aceaWLocalize +'</button>');
                    }
        ...
        $( ".acea-repeater-info" ).sortable({
            stop:function(event, ui) {
                $('.acea_special-wfield').trigger('change');
            }
        });
        $( ".acea-repeater-info" ).disableSelection();
        ...
        $(document).on('click', '.repeater-control-remove', function(e){
            ...
            $item.slideUp("normal", function(){
                $(this).remove();
                $('.acea-repeater-info').find('.single-repeater-field-wrap').each(function(index){
                    var $current = $(this),
                        $number = $current.find('.repeater_num'),
                        $wrapper = $current.closest('.acea-repeater-info-wrapper'),
        ...
        $(document).on('click', '.acea-widget-add-item', function(e){
            e.preventDefault();
            var $self = $(this),
                $widget = $self.closest('.widget.open'),
                $widget_id = $widget.attr('id'),
                $wrapper = $self.closest('.acea-repeater-info-wrapper'),
                ...
                $container = $wrapper.find('.acea-repeater-info'),
            ...
            var wrap_parent = $self.closest('.acea-repeater-info-wrapper'),
            data_type = wrap_parent.attr('data-field-id');
        ...
        $(document).on('click', '.single-repater-title', function(e){
            ...
            var $self = $(this),
                ...
                $wrapper = $self.closest('.acea-repeater-info'),
        ...
        $(document).on('click', '.sl-widget-up-btn', function(e){
            ...
            file_frame.on('select', function(){
                ...
                if ( $remover.length ) {
                    ...
                    $self.after('<button style="display: inline-block;" class="sl-widget-media-remove button" data-url="'+ aceaWLocalize.home_url +'">'+ aceaWLocalize.remove_img +'</button>');
                }
                $input.trigger('change');
            });
            file_frame.open();
